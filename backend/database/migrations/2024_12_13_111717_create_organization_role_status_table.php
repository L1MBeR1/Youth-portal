...
class CreateOrganizationRoleStatusTable extends Migration
{
    public function up()
    {
        Schema::create('organization_role_status', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('organization_role_status');
    }
}
