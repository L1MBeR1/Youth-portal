...
function DatePopOver({ label,fromDate,toDate,setFromDate,setToDate}) {
  ...
  const popover = (
    open && (
      <Sheet
        ...
        sx={{
          position: 'absolute',
          top: anchorEl ? anchorEl.getBoundingClientRect().bottom + window.scrollY + 10 : 0,
  ...
  return (
    <>
      ...
      {open && <div onClick={handleClose} style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%' }} />}
    </>
  );
}
