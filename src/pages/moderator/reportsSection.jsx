...
function ReportsSection() {
	...
	const handleExclude = () => {
		...
		excludeResource(
			null,
			selectedResource.reportable_type,
			selectedResource.reportable_id
		);
		...
		<Box>
			...
			<Modal open={isDialogOpen} onClose={() => setIsDialogOpen(false)}>
				...
				>
					...
					>
						<Button variant='soft' color='primary' onClick={handleOpenInNewTab}>
							Открыть в новой вкладке
						</Button>
						<Box sx={{ display: 'flex', gap: 1 }}>
							<Button variant='solid' color='primary' onClick={handleExclude}>
								Удалить жалобы
							</Button>
