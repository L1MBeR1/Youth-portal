            ...
            >
                <Avatar
                    ...
                    sx={{
                        ...
                        "--Avatar-size": { xs: "80px", sm: '90px', md: '110px', lg: '120px' },
                    }}
                />
            </Box>
            <Box
                ...
                >
                    <Box
                        sx={{
                            display: 'flex',
                            flexDirection: 'column',
                            paddingTop: { xs: "45px", sm: '50px', md: '60px', lg: '65px' },
                            gap:'5px'
                        }}
                    >
                        ...
                        <Stack direction="row" spacing={0.5}  alignItems="center">
                            ...
                            <Typography level="body-md">{profileData.last_name+' '+profileData.first_name+' '+profileData.patronymic}</Typography>
                        </Stack>
                        <Stack direction="row" spacing={0.5}  alignItems="center">
                        ...
                        >
                            ...
                            <Button sx={{borderRadius:'40px'}} variant='plain' size="lg">Настройки</Button>
                        </Stack>
                    </Box>
                    <Stack
                    spacing={4}
